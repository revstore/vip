...
TIMES="10"
CHATID="-10030911878"
KEY="6617696083:AAEbXm7JbDiX3mSzHWeDjHG2_qeNqCKxA"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To AutoScript Vip  ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/revstore/regist/main/afk | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/revstore/regist/main/afk | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
#https://raw.githubusercontent.com/revstore/regist/main/afk
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/revstore/regist/main/afk | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/revstore/vip/main/"
    #https://raw.githubusercontent.com/suprastore/youarefree/MONSTER
...
echo -e "     \e[1;32m2)\e[0m Gunakan Domain Random (DIGITAL OCEAN ONLY) "
echo -e "   ------------------------------------"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/revstore/regist/main/afk | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/revstore/regist/main/afk | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/Rev4youstore"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/Rev4youstore"}]]}'
